...
technique SeasonColored
{
	pass Pass0
	{
		VertexShader = compile vs_4_0_level_9_1  SeasonColoredVS();
		PixelShader = compile ps_4_0_level_9_1  SeasonColoredPS();
	}
}
...
technique SeasonColoredNoShading
{
	pass Pass0
	{
		VertexShader = compile vs_4_0_level_9_1  SeasonColoredNoShadingVS();
		PixelShader = compile ps_4_0_level_9_1  SeasonColoredNoShadingPS();
	}
}
//------- Technique: Colored --------
